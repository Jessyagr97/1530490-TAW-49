...
<body class="nav-md">
  <div class="container body">
    <div class="main_container">
      <div class="col-md-3 left_col menu_fixed">
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <a href="{{ url('/') }}" class="site_title"><span style="font-size: 19px;">Sistema Administrativo</span></a>
          </div>
            ...
            <div class="menu_section">
              <h3>General</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fas fa-home"></i>&nbsp;&nbsp;&nbsp;&nbsp;Inicio <span style="float: right" class="fa fa-chevron-down"></span></a>
      ...
      <!--Mostrar el contenido de cada una de las vistas unvocadas desde el controlador -->
      @yield('contenido');
